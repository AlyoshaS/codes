...
# Define o peso da carga convertida em quilos:
...
print("Peso da carga: {0}KG. \nPreço da carga: R${1}. \nValor total do imposto: R${2}. \nValor total da carga, incluindo o imposto: R${3}.".format(peso_kg, preco, valor_imposto, valor_carga))